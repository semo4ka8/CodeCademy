...
Creating a function that will find a line of best fit when given a set of data to predict the bounce of all kinds of sizes of balls he may choose to include in the ball pit!
