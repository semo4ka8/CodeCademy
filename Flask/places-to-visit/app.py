...
def add_location():
    ...
    return redirect(url_for('locations', category=category, _external=True, _sheme='https'))


@app.route("/")
def index():
    ## Redirect to locations route function
    return redirect(url_for('locations', category='recommended', _external=True, _sheme='https'))
